...
class Customer(models.Model):
    ...
    客户信息表
    """
    name = models.CharField(max_length=32, blank=True, null=True)  # blank 是django admin限制，所以成对出现
    ...
    referal_from = models.CharField(verbose_name='转介绍人QQ', max_length=64, null=True)
...
class ClassList(models.Model):
    ...
    班级表
    """
    branch = models.ForeignKey('Branach')
...
class StudyRecord(models.Model):
    ...
    def __str__(self):
        return "%s %s %s" % (self.enrolled_student, self.course_record, self.score)
